...
$sendingAccountUsername     = 'manoj.karkar@avanzarhealth.com';
$sendingAccountPassword     = 'manoj1993';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'manoj.karkar94@gmail.com'; // REQUIRED value.
$recipientName              = 'Manoj Karkar';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'This mail is from  GXPartners'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'avanzarhealth';                // REQUIRED value. This is used when a name or email is not collected from the website form
